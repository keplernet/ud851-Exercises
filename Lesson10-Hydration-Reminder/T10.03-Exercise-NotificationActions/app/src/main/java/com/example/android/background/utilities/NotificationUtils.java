...
public class NotificationUtils {
    ...
    private static final int ACTION_DISMISS_PENDING_INTENT_ID = 34171;
    private static final int ACTION_DRINK_PENDING_INTENT_ID = 34172;
    ...
    public static void remindUserBecauseCharging(Context context) {
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context)
                ...
                .setLargeIcon(largeIcon(context, R.drawable.ic_local_drink_black_24px)) //Le paso tb el id de la imagen
//                .setLargeIcon(largeIcon(context))
    ...
    //ALAN: Le paso tb un id para q valga para otras imagenes tambien.
//    private static Bitmap largeIcon(Context context) {
    private static Bitmap largeIcon(Context context, int id) {
        //ALAN: Pongo este valor por defecto:
        if(id == 0) id = R.drawable.ic_local_drink_black_24px;

        Resources res = context.getResources();
        Bitmap largeIcon = BitmapFactory.decodeResource(res, id); //ALAN: cambio por la variable id
